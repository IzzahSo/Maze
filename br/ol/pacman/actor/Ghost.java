...
public class Ghost extends PacmanActor {
    ...
    public void updateTitle() {
        ...
        if (pacman.direction == 0) {
            frameIndex = 8 + (int) (System.nanoTime() * 0.00001) % 2;
        }
        else if (pacman.direction == 2) {
            frameIndex = 2 * pacman.direction + (int) (System.nanoTime() * 0.00001) % 2;
        }
    ...
    public void updateAnimation() {
        ...
        switch (mode) {
            case CAGE: 
            case NORMAL:
                frameIndex = 2 * direction + (int) (System.nanoTime() * 0.00001) % 2;
                if (!markAsVulnerable) {
                    break;
                }
            case VULNERABLE:
                if (System.currentTimeMillis() - vulnerableModeStartTime > 5000) {
                    frameIndex = 8 + (int) (System.nanoTime() * 0.00002) % 4;
                }
                else {
                    frameIndex = 8 + (int) (System.nanoTime() * 0.00001) % 2;
                }
